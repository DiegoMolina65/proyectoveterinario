...
// Crear una lista de mascotas y sus dueños.
try {
    $sql = "SELECT Mascotas.*, Clientes.Nombre AS Nombre_Cliente, Clientes.Apellido AS Apellido_Cliente FROM Mascotas LEFT JOIN Clientes ON Mascotas.ID_Cliente = Clientes.ID_Cliente";
    $stmt = $conn->query($sql);
